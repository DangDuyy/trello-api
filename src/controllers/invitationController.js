...
const updateBoardInvitation = async (req, res, next) => {
  try {
    ...
    const updateBoardInvitation = await invitationService.updateBoardInvitation(userId, invitationId, status)
    res.status(StatusCodes.OK).json(updateBoardInvitation)
  }
  catch (err) {
    next(err)
  }
